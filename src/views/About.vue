          ...
          >
           <h1 class="text-center font-size">Top Picks</h1>
            <div class="text-center">
              <v-btn  to="/products" class="white--text " outlined>SHOP NOW</v-btn>
            </div>
          </v-img>
        </v-card>
      </div>
        ...
        <v-card outlined>
          ...
          >
            ...
            <div class="text-center mt-2">
              <v-btn class="white--text caption"  to="/products" text>SHOP NOW <v-icon class="white--text caption">mdi-arrow-right</v-icon></v-btn>
            </div>
          </v-img>
        </v-card>
      </div>
